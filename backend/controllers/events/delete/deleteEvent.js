...
const deleteEvent = async (req, res, next) => {
  ...
  try {
    ...
    const [photos] = await connection.query('SELECT photo FROM events_photos WHERE id_event=?', [idEvent]);
    ...
    await connection.query('DELETE FROM events_photos WHERE id_event=?;', [idEvent]);
